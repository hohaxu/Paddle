...
ctx_n2_embedding = embedding_layer(size=word_dim, input=ctx_n2, param_attr=ptt)
...
ctx_p2_embedding = embedding_layer(size=word_dim, input=ctx_p2, param_attr=ptt)
...
hidden_0 = mixed_layer(
    ...
    input=[
        ...
        full_matrix_projection(input=ctx_n2_embedding),
        ...
        full_matrix_projection(input=ctx_p2_embedding),
        full_matrix_projection(input=mark_embedding),
    ])

lstm_0 = grumemory(input=hidden_0, layer_attr=layer_attr)
